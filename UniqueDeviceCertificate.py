...
class Private1835362660(MyPrivateType):
    tagSet = univ.Sequence.tagSet.tagImplicitly(tag.Tag(tag.tagClassPrivate, tag.tagFormatConstructed, 1835362660))
    componentType = namedtype.NamedTypes(
        namedtype.NamedType('meid', char.IA5String()),
        namedtype.NamedType('OCTET_STRING', univ.OctetString())
    )
...
private_data1['INTEGER'] = 6
private_data2 = Private1128810832()
private_data2['CHIP'] = 'CHIP'
private_data2['INTEGER'] = 28672
private_data3 = Private1162037572()
private_data3['ECID'] = 'ECID'
private_data3['INTEGER'] = 696171533255718
private_data4 = Private1651335523()
private_data4['bmac'] = 'bmac'
private_data4['OCTET_STRING'] = '70:ec:e4:dc:e3:ca'
private_data5 = Private1768777065()
private_data5['imei'] = 'imei'
private_data5['OCTET_STRING'] = '359315069818069'
private_data6 = Private1835362660()
private_data6['meid'] = 'meid'
private_data6['OCTET_STRING'] = '35931506981806'
private_data7 = Private1936879213()
private_data7['srnm'] = 'srnm'
private_data7['OCTET_STRING'] = 'C6KPT3RPG5MP'
private_data8 = Private1969514852()
private_data8['udid'] = 'udid'
private_data8['OCTET_STRING'] = '3e76c32896a0e54f99ef95a211d9aa05dd7686a6'
private_data9 = Private2003657059()
private_data9['wmac'] = 'wmac'
private_data9['OCTET_STRING'] = '70:ec:e4:dc:e3:c9'
# private_data10 = Private1936025956()
# private_data10['seid'] = 'seid'
# private_data10['OCTET_STRING'] = '041019E354426767667666776776767670942330279BECB1C9ABDA68'
...
# extension1_data.extend([private_data1, private_data2, private_data3, private_data4, private_data5, private_data6, private_data7, private_data8, private_data9, private_data10)
...
extension1 = UnrecognizedExtension(
            oid=ObjectIdentifier('1.2.840.113635.100.10.1'),
